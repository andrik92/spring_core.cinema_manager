...
public class TestAuditoriumService extends AbstractJUnit4SpringContextTests {
	...
	public void testSomeAuditoriums() {
		...
		for (Auditorium auditorium : auditoriums) {
			Auditorium auditorium1 = service.getByName(auditorium.getName());
			Assert.assertNotNull(auditorium1);
		}

		Auditorium auditorium = service.getByName("000");
		Assert.assertNull(auditorium);
	}
